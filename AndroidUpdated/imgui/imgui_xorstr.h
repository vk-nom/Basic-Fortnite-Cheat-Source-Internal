...
namespace jm {
    ...
    namespace detail {
        ...
        template<auto... Css>
        struct tstring_ {
            using value_type = typename pack_value_type<Css...>::type;
            constexpr static std::size_t size = sizeof...(Css);
            constexpr static value_type  str[size] = { Css... };
    ...
    XORSTR_FORCEINLINE constexpr auto make_xorstr(Tstr str_lambda, std::index_sequence<StringIndices...>, std::index_sequence<KeyIndices...>) noexcept {
